            ...
            <Card className="shadow-lg rounded-2xl overflow-hidden">
              ...
              {/* <CardFooter className="flex items-center justify-between px-4 py-2 border-t">
                ...
                <div className="flex items-center space-x-1 text-xs">
                  {video.status === 'ready' ? (
                    <><CheckCircle className="w-4 h-4 text-green-500" /><span className="text-green-600">Ready</span></>
                  ) : (
                    <><AlertCircle className="w-4 h-4 text-yellow-500" /><span className="text-yellow-600">{video.status}</span></>
                  )}
                </div>
              </CardFooter> */}
