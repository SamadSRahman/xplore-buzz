...
export default function UploadPage() {
  ...
  const uploadFile = async () => {
    ...
    try {
      ...
      const interval = setInterval(() => {
        setFileObj((f) =>
          f.progress < 95 ? { ...f, progress: f.progress + 5 } : f
        );
      }, 150);
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case "uploading":
        return (
          <div className="w-6 h-6 border-4 border-gradient-to-r from-purple-500 to-pink-500 border-t-transparent rounded-full animate-spin" />
        );
      case "completed":
    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      >
        ...
        <Card
          ...
          } transition-all duration-300 shadow-md rounded-2xl mb-6`}
        >
            ...
            >
              ...
              {fileObj && (
                <motion.div
                  ...
                  className="flex items-center justify-between w-full max-w-lg mx-auto bg-white p-4 rounded-lg shadow-inner"
                >
        ...
        {fileObj?.status === "completed" && (
          <motion.div
            ...
            className="mt-8 p-6 text-center bg-green-50 rounded-2xl shadow-inner"
          >
            ...
            <p className="text-green-600 mb-4">
              Your video is now ready for annotations.
            </p>
            <Button
              size="sm"
              onClick={() => router.push(`/video/${fileObj.videoId}`)}
              className="text-white bg-green-600 hover:bg-green-700 transition-all rounded-md"
            >
              Go to Video
            </Button>
          </motion.div>
