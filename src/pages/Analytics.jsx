...
const AnalyticsPage = () => {
  ...
  const [timeRange, setTimeRange] = useState("30d"); // Add time range state
  ...
  useEffect(() => {
    if (videoId) {
      getVideoAnalyticsSummary(videoId, timeRange); // Use timeRange from state
    }
  }, [videoId, timeRange]); // Add timeRange to dependency array
