...
//       {/* <span className="text-white font-bold text-sm">B</span> */}
//       <image src="./assets/joraxemdnigupvudqheb.png" alt="" />
//     </div>
//     <span className="text-2xl font-bold bg-buzz-gradient bg-clip-text text-transparent">
//       BUZZ
//     </span>
...
export default function Navbar() {
  ...
  return (
    <motion.nav
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 overflow-hidden"
    >
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
